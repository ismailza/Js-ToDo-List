...
function removeItem() 
{
  ...
  if (id === 'todo') data.todo.splice(data.todo.indexOf(value), 1);
  else data.completed.splice(data.completed.indexOf(value), 1);
  dataObjectUpdated();
...
function completeItem() 
{
  ...
  var target = (id === 'todo') ? document.querySelector('#completed'):document.querySelector('#todo');
  parent.removeChild(item);
